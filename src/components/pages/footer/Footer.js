        ...
        <div className="footerBlocks">
          <div className="leftBlock">
            ...
            <div className="footerCompanyInfo">
              ООО "Еподача" Зарегистрировано Минским горисполкомом 12.04.2021,
              УНП 191304775 г.Минск, пр-т Дзержинского, 57, 10 этаж, помещение
              45-1. Режим работы предприятия: пн.-пт. 09.00-17.00, вых. дн. –
              сб., вс. Режим работы сайта – круглосуточно. E-mail ООО "Еподача"
              nadezhda.chernookaya@gmail.com р/с BY12ALFA30122600730090270000
